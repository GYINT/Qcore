...
> v3.3 | 行业背书: ISO9000/CMMI/VDA6.3/QMS 四范式（置信度0.85）| V8.0+ 13 协议术语 + 4 形态 + 5 范式 + 缺口暴露驱动
...
## V8.0+ 13 协议术语（对齐 action-orders.md §1-§13）
...
### V6.1-6.3 5 范式术语（Skill 标准化）

| 术语 | 定义 | 来源 |
|------|------|------|
| **5 范式** | 单一职责/契约驱动/渐进增强/可观测设计/防御性输出 | SKILL.md §0.2 |
